...
.. code:: python
    ...
    X, y = shampoo.load_example()

    # Learn model on the data
    model = shampoo.fit_transform(X, y, pos_label='bad')

    # Plot the model performance
    results = shampoo.plot(model)
...
.. code:: python
    ...
    # Retrieve URLs of malicous and normal urls:
    model = shampoo.fit_transform(X, y_true, pos_label='bad', train_test=True, gridsearch=True)
...
.. code:: python
    ...
    # Retrieve URLs of malicous and normal urls:
    model = shampoo.fit_transform(X, y_true, pos_label='bad', train_test=False, gridsearch=True)
